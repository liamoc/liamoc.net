...
*Update 28/09/2014: Agda snippets were updated to work with the latest standard library and Agda version.*

*Note: The Agda snippets in this post are interactive! Click any identifier to jump to its definition,
be it in the standard library or earlier in this post.*
